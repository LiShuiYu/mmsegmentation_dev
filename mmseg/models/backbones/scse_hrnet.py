...
class BasicBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = build_conv_layer(
            ...
            dilation=dilation,
            bias=False)
        self.scse1 = scSE(planes)
        self.add_module(self.norm1_name, norm1)

        self.conv2 = build_conv_layer(
            conv_cfg, planes, planes, 3, padding=1, bias=False)
        self.scse2 = scSE(planes)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv3 = build_conv_layer(
            ...
            kernel_size=1,
            bias=False)
        self.scse3 = scSE(planes * self.expansion)
...
class SCSE_HRNet(nn.Module):
    ...
    def __init__(self,
        ...
        super(SCSE_HRNet, self).__init__()
        self.extra = extra
        self.conv_cfg = conv_cfg
        self.norm_cfg = norm_cfg
    ...
    def train(self, mode=True):
        ...
        layer freezed."""
        super(SCSE_HRNet, self).train(mode)
